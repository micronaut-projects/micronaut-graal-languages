...
Sign the [Contributor License Agreement (CLA)](https://cla-assistant.io/micronaut-projects/micronaut-graal-languages). This is required before any of your code or pull-requests are accepted.
...
Micronaut graal-languages currently requires JDK 17.

## IDE Setup

Micronaut graal-languages can be imported into IntelliJ IDEA by opening the `build.gradle` file.

## Docker Setup

Micronaut graal-languages tests currently require Docker to be installed.
